...
Dans les diagrammes des niveaux N=4, N=5, ajouter le composant **Self-Model** dans chaque workspace. Par exemple, pour le niveau N=5 (Groupe), le diagramme des Officiers deviendrait :



Ajouter également une phrase descriptive dans la section `architecture.md` :  
